    ...
    <div className="space-y-8">
      <Card className="border-gold/20">
        <CardHeader className="text-center bg-gold/10 border-b border-gold/20">
          <CardTitle className="text-3xl font-serif">You're Cordially Invited</CardTitle>
          <CardDescription className="text-xl">to a Surprise Engagement Celebration</CardDescription>
          <div className="mt-4">
        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-8 space-y-4 text-center">
            <p>
              With hearts full of joy and thanksgiving, we are excited to celebrate the love story of Layla and Emmanuel
              as they take this beautiful step toward forever.
            </p>
            <p className="font-medium">
              This will be a surprise for Layla, so we kindly ask all guests to arrive on time and keep the celebration
              a joyful secret until the special moment is revealed.
            </p>
            <p>
              Let us gather together in love, laughter, and blessings as we witness the beginning of a God-ordained
              union.
            </p>
            <p className="italic">"Therefore what God has joined together, let no one separate." Mark 10:9</p>
          ...
          <div className="mt-8 p-4 bg-gold/10 rounded-lg text-center">
            ...
            <p className="text-sm">(Kindly dress in theme to honor the couple)</p>
          </div>
          ...
          <div className="mt-8 border-t pt-6">
            <div className="text-center">
              ...
              <p className="text-green-600 font-medium">
                You are attending{rsvp.plus_one && rsvp.plus_one_name ? ` with ${rsvp.plus_one_name}` : ""}
              </p>
              <div className="mt-4">
        ...
        <div className="mt-8 border-t pt-6">
          <div className="text-center">
            ...
            <div className="mt-4">
              <WeChatGroupModal userId={user.id} joinedWeChat={joinedWeChat} onJoined={() => setJoinedWeChat(true)} />
            </div>
            {joinedWeChat && <p className="text-green-600 text-sm mt-2">✓ You've joined the WeChat group</p>}
          </div>
        </div>
      </Card>
    </div>
